...
;     c = vso_get(try1[con3],out_dir=outstring,/force)
    ...
    ;     ;   break
        IF ((filelist[k].EndsWith('0_s4c1a.fts') EQ 1) AND (filelist[k+1].EndsWith('9_s4c1a.fts') EQ 1) AND (filelist[k+2].EndsWith('8_s4c1a.fts') EQ 1)) OR ((filelist[k].EndsWith('0_s4c1b.fts') EQ 1) AND (filelist[k+1].EndsWith('9_s4c1b.fts') EQ 1) AND (filelist[k+2].EndsWith('8_s4c1b.fts') EQ 1)) THEN BEGIN
