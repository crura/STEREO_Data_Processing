function stereo_process, directory
  ...
  spawn, 'mkdir -p /Volumes/Seagate/Chris/2017_Images'
  fname = '/Volumes/Seagate/Chris/2017_Images/process_error_log.log'
  fname2 = '/Volumes/Seagate/Chris/2017_Images/process_log.log'
  OPENW,1,fname
  OPENW,2,fname2
  ; ;month string
  FOR j =1, 12 DO BEGIN
