function stereo_process, directory
  ...
  fname = '/Volumes/Seagate/Chris/2007_Images/process_error_log.log'
  fname2 = '/Volumes/Seagate/Chris/2007_Images/process_log.log'
  OPENW,1,fname
  OPENW,2,fname2
  ; ;month string
  FOR j =1, 12 DO BEGIN
  ...
  FOR i = 1, 31 DO BEGIN
    ...
    try1 = vso_search(date='2007/' + monthstring + '/' + istring + 'T09:35:00-2007/' + monthstring + '/' + istring + 'T17:45:25', inst='COR1',source='STEREO-B',info=0,out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring)
    try2 = vso_search(date='2007/' + monthstring + '/' + istring + 'T09:35:09-2007/' + monthstring + '/' + istring + 'T17:45:25', inst='COR1',source='STEREO-B',sample=600,info=120,out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring)
    try3 = vso_search(date='2007/' + monthstring + '/' + istring + 'T09:35:18-2007/' + monthstring + '/' + istring + 'T17:45:25', inst='COR1',source='STEREO-B',sample=600,info=240,out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring)
    ...
    spawn, 'mkdir -p /Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring

    a = vso_get(try1[con1],out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring,/force)
    b = vso_get(try1[con2],out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring,/force)
    c = vso_get(try1[con3],out_dir='/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring,/force)

    cd, '/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring
    setenv, "SECCHI_BKG=/Users/crura/stereo/secchi/backgrounds"

    spath = '/Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring + '/processed'
    spawn, 'rm *s5c1B.fts'
    spawn, 'mkdir -p /Volumes/Seagate/Chris/2007_Images/B/2007' + monthstring +istring + '/processed'
